...
import { ProductSearchService, mockProducts } from '@projectecommerce/product-data-access';
import { of } from 'rxjs';
...
describe('ProductSearchComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers:[
        {
          provide:ProductSearchService, // qdo o componente visualizar esse service , na verdade ele vai utilizar essa implementação
